...
- [ ] Task: Define the core API architecture and base routing for the Tooie Local API.
- [ ] Task: Write tests to ensure the local HTTP server starts and responds correctly.
